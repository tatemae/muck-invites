...
MuckInvites.configure do |config|
  config.use_gravatar_in_photo_list = true
end
...
and add it to your Gemfile
  ...
  gem 'muck-oauth', :require => 'muck_oauth'
  
See the muck-oauth gem for more information - http://github.com/tatemae/muck-oauth

=== Inviter model
Add 'include MuckInvites::Models::Inviter' to the class that you wish to have do the inviting.  This is commonly the user model, but
