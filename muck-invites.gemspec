...
Gem::Specification.new do |s|
  ...
  s.date = "2011-09-21"
  s.description = "The invite engine for the muck system."
  ...
  s.summary = "The invite engine for the muck system"

  if s.respond_to? :specification_version then
    s.specification_version = 3

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<muck-contacts>, [">= 2.6.1"])
      ...
      s.add_dependency(%q<muck-contacts>, [">= 2.6.1"])
